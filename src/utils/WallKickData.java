...
public class WallKickData {
  ...
  private static Point2D getDefaultKickData(int rotationState, int direction,
      int kickIndex) {
  ...
  private static Point2D getArikaKickData(int rotationState, int direction,
      int kickIndex) {
    int directionIndex = direction == RIGHT ? 0 : 1;
    return new Point2D.Double(
  ...
  public static Point2D getKickData(int shapeIndex, int rotationState,
      int direction, int kickIndex) {
    if (shapeIndex == I) {
